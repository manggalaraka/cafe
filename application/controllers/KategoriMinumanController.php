...
class KategoriMinumanController extends CI_Controller {
	...
	public function kategori_minuman_ajax(){
		 $data = array();
		 $data['listKategori'] = $this->M_jenis_makanan->selectDrinkOnly();
		 $view = $this->load->view('superadmin/v_add_kategori_minuman.php',$data,true);
